...
Start by adding the \texttt{ohmage-2.11} package respository to our system:

\begin{verbatim}
    sudo apt-get install python-software-properties
    sudo add-apt-repository ppa:opencpu/ohmage-2.11
\end{verbatim}
...
\begin{verbatim}
    sudo apt-get remove --purge ohmage-*
